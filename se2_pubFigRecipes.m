...
out  = se2_pubFigs(Dall , 'Eye', 'presspositionlook-ahead' , 'isSymmetric' , 1 , 'poolDays' , 0);
...
%%
stats = se2_SigTest(Dall , 'IPI' , 'seqNumb' , [0] , 'Day' , [1 4 5] , 'Horizon' , [1:13],...
    'PoolDays' , 1,'whatIPI','WithBetRand','PoolSequences' , 0 ,...
    'PoolHorizons' , [],'ipiOfInterest' , [0] , 'poolIPIs' , 0 , 'subjnum' , [1:13]);
%%
stats = se2_SigTest(Dall , 'IPI' , 'seqNumb' , [0] , 'Day' , [1 4 5] , 'Horizon' , [1:13],...
    'PoolDays' , 1,'whatIPI','prsnumb','PoolSequences' , 0 ,...
    'PoolHorizons' , [],'ipiOfInterest' , [0] , 'poolIPIs' , 0 , 'subjnum' , [1:13]);
...
stats = se2_SigTest(Dall , 'PercentMTwithinseqType' , 'seqNumb' , [0] , 'Day' , [1 2 3] , 'Horizon' , [3:13],...
    ...
    'PoolHorizons' , [],'ipiOfInterest' , [0] , 'poolIPIs' , 0 , 'subjnum' , [1:13]);
%% Saccade Frequency
stats = se2_SigTest(Dall , 'Eye_seq_sacPerSec' , 'seqNumb' , [0] , 'Day' , [1] , 'Horizon' , [1:13],...
    'PoolDays' , 1,'whatIPI','WithBetRand','PoolSequences' , 0 ,...
...
stats = se2_SigTest(Dall , 'Eye_seq_sacAmp' , 'seqNumb' , [0] , 'Day' , [1 5] , 'Horizon' , [13],...
    ...
    'PoolHorizons' , [],'ipiOfInterest' , [0 2] , 'poolIPIs' , 0 , 'subjnum' , [1:13],'isSymmetric' , 1);
%%
stats = se2_SigTest(Dall , 'Eye_ipi_fixDur_ipitype' , 'seqNumb' , [0:2] , 'Day' , [2:5] , 'Horizon' , [1:13],...
    'PoolDays' , 0,'whatIPI','WithBetRand','PoolSequences' , 0 ,...
    'PoolHorizons' , [7:13],'ipiOfInterest' , [0:3] , 'poolIPIs' , 0 , 'subjnum' , [1:13],'isSymmetric' , 1, 'prsnumb' , [4:10]);
%%
stats = se2_SigTest(Dall , 'Eye_ipi_lookahead_ipitype' , 'seqNumb' , [0:2] , 'Day' , [2:5] , 'Horizon' , [1:13],...
    'PoolDays' , 0,'whatIPI','WithBetRand','PoolSequences' , 0 ,...
    'PoolHorizons' , [7:13],'ipiOfInterest' , [1:3] , 'poolIPIs' , 0 , 'subjnum' , [1:13],'isSymmetric' , 1);

%%
stats = se2_SigTest(Dall , 'Eye_ipi_lookahead_prsnumb' , 'seqNumb' , [0] , 'Day' , [2:5] , 'Horizon' , [7:13],...
    'PoolDays' , 1,'whatIPI','WithBetRand','PoolSequences' , 0 ,...
    'PoolHorizons' , [],'ipiOfInterest' , [0:3] , 'poolIPIs' , 0 , 'subjnum' , [1:13],'isSymmetric' , 1 , 'prsnumb' , [1:14]);
