...
%                 MT.Horizon(MT.Horizon>6) = 6;
                ...
                set(gca,'FontSize' , 18  , 'GridAlpha' , .2 , 'Box' , 'off' , 'YLim' , [2000 8000],'YTick' ,...
                        ...
                        for sq = 1:length(seqN)
                            ...
                            for h = 1:6
                                stats = se2_SigTest(Dall , 'MT' , 'seqNumb' , seqN{sq} , 'Day' , dayz{d} , 'Horizon' , [h:13],...
                                    ...
                                    'PoolHorizons' , [7:13],'ipiOfInterest' , [] , 'poolIPIs' , 0 , 'subjnum' , subjs(sn));
...
%                 for sn = 1:2
%                     colorz = colz(1:length(dayz) , sn);
%                     for dd = 1:length(unique(EH.Day))
%                         subplot(2,3,fcount)
%                         E = getrow(EH , EH.Day==dd & EH.sq == sn);
%                         histogram(E.effH)
%                         fcount = fcount+1;
%                         set(gca , 'FontSize' , 18 , 'XLim' , [0 5.5] , 'XTick' , [2 3 4]  , 'YLim' , [0 10])
%                     end
%                 end
%                 
